# python video_vis.py /home/lyn/Videos/flare1.mp4 /home/lyn/HitLyn/metrabs/outputs/flare1.txt
import sys
import numpy as np
...
def main():
    ...
    viz = poseviz.PoseViz(joint_names, joint_edges, high_quality=False)
    ...
    for frame_batch in frame_batches:
        ...
        camera = cameralib.Camera.from_fov(fov_degrees=55, imshape=frame_batch.shape[1:3])
